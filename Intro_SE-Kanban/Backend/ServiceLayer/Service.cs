...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class Service : IService
    {
        ...
        public Response LoadData()
        {
            ...
            Response userLoad = _userService.LoadData();
            if (userLoad.ErrorOccured) return userLoad;
            Response board = _boardService.LoadData();
            if (board.ErrorOccured) return board;
        ...
        public Response Register(string email, string password, string nickname)
        {
            ...
            Response reg = _userService.Register(email, password, nickname);
            _boardService.AddUserBoard(email);
            return reg;
        }
        ...
        {
            Response reg= _userService.Register(email, password, nickname, emailHost);
            _boardService.addMember(email, emailHost);
            return reg;
        }
        ...
        {
            return _boardService.AssignTask(email, columnOrdinal, taskId, emailAssignee, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.DeleteTask(email, columnOrdinal, taskId, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.GetBoard(email, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.LimitColumnTasks(email, columnOrdinal, limit, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.AddTask(email, title, description, dueDate, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.UpdateTaskDueDate(email, columnOrdinal, taskId, dueDate, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.UpdateTaskTitle(email, columnOrdinal, taskId, title, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.UpdateTaskDescription(email, columnOrdinal, taskId, description, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.AdvanceTask(email, columnOrdinal, taskId, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.GetColumn(email, columnName, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.GetColumn(email, columnOrdinal, _userService.LoggedIn());
        }

        ///<summary>Remove all persistent data.</summary>
        public Response DeleteData()
        {
            Response a = _userService.DeleteData();
            _boardService.DeleteData();
            return a;
        }
        /// <summary>
        ...
        {
            return _boardService.RemoveColumn(email, columnOrdinal, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.AddColumn(email, columnOrdinal, Name, _userService.LoggedIn());
        }
        ...
        {
            return _boardService.MoveColumnRight(email, columnOrdinal, _userService.LoggedIn());
        ...
        {
            return _boardService.MoveColumnLeft(email, columnOrdinal, _userService.LoggedIn());
        ...
        {
            return _boardService.ChangeColumnName(email, columnOrdinal, newName,_userService.LoggedIn());
        }
    }
}
